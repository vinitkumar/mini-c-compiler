...
class x86Registers:
    ...
    def _copy_reg_to_temp(self, valid_regs, comment_str=None):
        ...
        self.o("  movl {}, {}".format(reg, mem), comment_str)
    ...
    def _coerce_type(self, curr_reg, from_type, to_type):
        ...
        if from_str == "char":
            ...
            if to_str == "char":
                self.o(
                    "  movzbl {}, {}".format(self.lo(curr_reg), curr_reg), comment_str
                )
                return curr_reg
    ...
    def _pop(self, valid_regs):
        ...
        self.o("  movl {}, {}".format(loc, reg), "Stack machine: copy temp to register")
...
class CodeGenVisitor(Visitor):
    ...
    def vStringLiteral(self, node):
        ...
        self.o(
            "  movl ${}, {}".format(label_str, self.stack.push(node.type)),
    ...
    def vId(self, node):
        ...
        if node.output_addr:
            self.o(
                "  leal {}, {}".format(node.symbol.compile_loc, self.stack.push()),
    ...
    def _binop_assign(self, node):
        ...
        self.o(
            "  {} {}, ({})".format(instr, right_reg, left_reg),
        ...
        self.o(
            "  {} ({}), {}".format(instr, left_reg, self.stack.push(node.type)),
    ...
    def _binop_arith(self, node):
        ...
        self.o("  {} {}, {}".format(instr, r_reg, l_reg), "Perform '%s'" % node.op)
        self.stack.done()
    ...
    def _binop_compare(self, node):
        ...
        self.o(
            "  cmpl {}, {}".format(right_reg, left_reg),
        ...
        self.o(
            "  {} {}".format(self.binop_instructions[node.op], lo),
            "Perform '%s'" % node.op,
        )
        self.o("  movzbl {}, {}".format(lo, byte_reg), "Zero-extend the boolean result")
    ...
    def vPointer(self, node):
        ...
        if type_str in ["int", "pointer"]:
            ...
            instr = "movzbl"
        self.o("  {} ({}), {}".format(instr, reg_from, reg_to), "Pointer dereference")
        self.stack.done()
