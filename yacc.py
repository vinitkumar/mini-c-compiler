...
#
# $Header: /cygdrive/c/prog/CVS/mini_c/yacc.py,v 1.1.1.1 2004/05/27 06:40:38 varmaa Exp $
#
...
def initialize_vars():
    ...
    Signature = hashlib.md5.new()  # Digital signature of the grammar rules, precedence
    ...
    while ji < len(J):
        ...
        for B in p.lr1_after:
            ...
            for b in first(f):
                ...
                pn = B.lr_next
                if pn.lr_added.get(b, 0) == _lr1_add_count:
                    continue
